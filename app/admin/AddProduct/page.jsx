...
const Page = () => {
  ...
  return (
    <div className="p-form container mx-auto px-4 h-[90vh]">
      <form onSubmit={onSubmitHandler} className="bg-white border border-gray-200 h-full w-full flex flex-col justify-between p-6">
